/* this test is based on the iterator example from
 * https://en.wikipedia.org/wiki/Setcontext
 * but uses libtealet.
 * It is instructive to compare the two to appreciate the difference
 */
#include <stdio.h>
#include <stdlib.h>
 ...
 *                        flow by switching contexts. */
tealet_t *main_tealet, loop_tealet;
...
int main(void)
{
    /* Initialize the main tealet with a malloc allocator */
